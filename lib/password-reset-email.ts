  ...
  try {
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        text: `Recebemos um pedido para redefinir sua senha. Acesse ${resetUrl}. O link expira em 30 minutos. Se você não fez o pedido, ignore esta mensagem.`,
        html: `<div style="background:#0b0b0b;color:#f6f0e5;font-family:Arial,sans-serif;padding:32px"><h1 style="color:#c6a66a">Redefinição de senha</h1><p>Recebemos um pedido para redefinir sua senha.</p><p><a href="${safeResetUrl}" style="background:#c6a66a;color:#17120b;display:inline-block;padding:14px 22px;text-decoration:none">Criar nova senha</a></p><p style="color:#a69d91">Este link expira em 30 minutos. Se você não fez o pedido, ignore esta mensagem.</p></div>`,
      }),
    });
