...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="pt-BR">
      <body>{children}<PwaInstallInvitation /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BeautySalon", name: "Jaqueline Justino Beauty Studio", image: "/proprietaria-jaqueline-studio.png", areaServed: "Fortaleza, CE", priceRange: "$$" }) }} /></body>
    </html>
  );
}
